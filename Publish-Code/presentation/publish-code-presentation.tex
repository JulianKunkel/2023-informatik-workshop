	...
	\section{Hide your secrets!}
		...
		\begin{frame}{Sensitive data in git}
			\begin{itemize}
				...
				\item e.g. passwords, application secret keys, OAuth secret keys
		...
		\begin{frame}{Removing sensitive data}
			This slide can show the process of removing the private data if a practical exercise is desired
